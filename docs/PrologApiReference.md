...
Call an instance method of a Java object, or a static method fo a Java class.
...
Set the Fspec field of the object or class represented by X to value V.
...
Type is the JPL type of Object, e.g. array(boolean), class([javax,sql],['Timestamp']).
...
Enumeration is a JPL reference to a Java object whose class implements the java.util.Enumerationinterface.
